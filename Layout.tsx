...
import { Activity, BookOpen, BarChart2, Video, Settings, Menu, ShieldCheck, Terminal, MessageSquare, HeartPulse, FileText, LogOut, User, TrendingUp } from 'lucide-react';
...
const Layout: React.FC<LayoutProps> = ({ children, activeTab, onTabChange }) => {
  ...
  const navItems = [
    ...
    { id: 'progress', label: 'Progress', icon: TrendingUp }, // Added Progress
